...
class InsightsRequestHandlerTest {

	private static TestContext context;
	private static HttpHeaders httpHeaders = new HttpHeaders();
	private static ObjectMapper objectMapper = null;
	private static CallerContext callerContext;
	private static final ChelloLogger chelloLogger = ChelloLoggerFactory.getInstance(InsightsRequestHandlerTest.class);
	...
	@Autowired
	private InsightsRequestHandler handleGenerateInsights;
