...
/**
* A simple mock implementation of the {@code ContextUserMapping} interface. Default
...
/*
 * @SuppressWarnings("deprecation") public TestContext() { try {
 * AWSXRay.getCurrentSegment(); }catch(Exception e) { Entity
 * mySegment=AWSXRay.beginSegment("test-segment");
