 ...
 * parameter.
 */
public class InsightsRequestHandler2 implements RequestHandler<Map<String, Object>, String> {
	 ...
	 */
	  ...
	  public InsightsRequestHandler2() { 
	...
	private static final ChelloLogger chelloLogger = ChelloLoggerFactory.getInstance(InsightsRequestHandler2.class);
