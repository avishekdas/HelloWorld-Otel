 ...
 * parameter.
 */
public class PostDataRequestHandler extends BaseRequestHandler {
	 ...
	 */
	  ...
	  public PostDataRequestHandler() { 
		  chelloLogger.log(ChelloLogLevel.DEBUG, "Initializing PostDataRequestHandler");
		  ctx.getAutowireCapableBeanFactory().autowireBean(this); 
	  }
	 

	/** The chelloLogger to log the request and responses for tracking. */
	private static final ChelloLogger chelloLogger = ChelloLoggerFactory.getInstance(PostDataRequestHandler.class);

	public Response handleRequest(Request request, Context context) {
		chelloLogger.log(ChelloLogLevel.INFO, "PostDataRequestHandler: Enterted in handleRequest() eventMap : " + request);

		Response<String> response = new Response<>();
		chelloLogger.log(ChelloLogLevel.INFO, "Enter PostDataRequestHandler : HandleGetInsights" + request,
